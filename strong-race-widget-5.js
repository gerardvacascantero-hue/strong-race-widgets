(function() {
  ...
  if (!document.getElementById('sr-styles')) {
    ...
    s.textContent = `
      ...
      .p3-unit{font-weight:700;font-size:14px;letter-spacing:.06em;text-transform:uppercase;color:var(--sr-muted)}.p3-code{font-weight:400;font-size:11px;color:var(--sr-ac);letter-spacing:.06em;margin-bottom:16px;opacity:.85}
  ...
  document.getElementById('sr-hotels').innerHTML=HOTELS.map(h=>`
    <div class="p3-card">
      ...
      <div class="p3-bd">
        ...
        ${h.code?`<div class="p3-code">${h.code}</div>`:''}
      </div>
